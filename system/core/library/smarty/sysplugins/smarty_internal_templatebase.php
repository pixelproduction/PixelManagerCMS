...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data
{
     ...
     *
     * @param  UTF8String|object $template   the resource handle of the template file or template object
     ...
     *
     * @param object     $parent next higher level of Smarty variables
     * @param UTF8String $name   optional data block name
     *
     ...
     *
     * @param UTF8String $template_name
     ...
     *
     * @param  UTF8String $type       plugin type
     * @param  UTF8String $tag        name of template tag
     ...
     * Unregister Plugin
     *
     * @param  UTF8String $type of plugin
     * @param  UTF8String $tag  name of plugin
     *
     * @return Smarty_Internal_Templatebase current Smarty_Internal_Templatebase (or Smarty or
     *                                      Smarty_Internal_Template) instance for chaining
     */
     ...
     *
     * @param  UTF8String            $type     name of resource type
     ...
     *
     * @param  UTF8String           $type     name of cache resource type
     ...
     *
     * @param         $class_name
     * @param  UTF8String $class_impl the referenced PHP class to register
     *
     * @throws SmartyException
     * @return Smarty_Internal_Templatebase current Smarty_Internal_Templatebase (or Smarty or
     *                                      Smarty_Internal_Template) instance for chaining
     ...
     *
     * @return UTF8String   internal filter name
     */
     ...
     *
     * @param  UTF8String $match match string
     *
     * @return UTF8String replacemant
     */
     ...
     *
     * @param UTF8String $name unknown method-name
