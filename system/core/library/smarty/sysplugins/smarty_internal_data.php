...
class Smarty_Internal_Data
{
     ...
     *
     * @param  array|UTF8String $tpl_var the template variable name(s)
     ...
     *
     * @param  UTF8String $varname the global variable name
     * @param  mixed      $value   the value to assign
     * @param  boolean    $nocache if true any output of this variable will be not cached
     *
     * @return Smarty_Internal_Data current Smarty_Internal_Data (or Smarty or Smarty_Internal_Template) instance for chaining
     ...
     *
     * @param  UTF8String|array $tpl_var the template variable(s) to clear
     *
     * @return Smarty_Internal_Data current Smarty_Internal_Data (or Smarty or Smarty_Internal_Template) instance for chaining
     */
     ...
     *
     * @param  UTF8String $config_file filename
     ...
     *
     * @param  UTF8String $variable       the name of the Smarty variable
     * @param  object     $_ptr           optional pointer to data object
     ...
     *
     * @param  UTF8String $variable the name of the config variable
     * @param bool        $error_enable
     *
     ...
     *
     * @param  UTF8String $variable the stream of the variable
     *
