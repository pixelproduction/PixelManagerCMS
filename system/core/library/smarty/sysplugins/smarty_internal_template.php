...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
     ...
     *
     * @param UTF8String               $template_resource template resource string
     ...
     *
     * @returns UTF8String template content
     */
     ...
     * @param array      $data           passed parameter template variables
     * @param int        $parent_scope   scope in which {include} should execute
     * @param UTF8String $hash           nocache hash code
     * @param UTF8String $content_func   name of content function
     *
     ...
     *
     * @param UTF8String                       $name        template function name
     ...
     *
     * @param UTF8String $tpl_var template variable name
     ...
     *
     * @param UTF8String $property_name property name
