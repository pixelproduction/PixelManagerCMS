 ...
 * @property UTF8String $content   Source Content
 */
class Smarty_Template_Source
{
     ...
     * @param UTF8String      $resource full template_resource
     * @param UTF8String      $type     type of resource
     * @param UTF8String      $name     resource name
     *
     ...
     *
     * @param  UTF8String $property_name valid: timestamp, exists, content, template
     ...
     *
     * @param  UTF8String $property_name valid: timestamp, exists, content
     *
     * @return mixed
     * @throws SmartyException if $property_name is not valid
     */
