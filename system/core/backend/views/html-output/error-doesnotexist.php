...
<head>
    ...
    <title><?php echo Translate::get('Error'); ?></title>
...
<div class="pixelmanager-iframe-wrapper">
    ...
    <div class="pixelmanager-iframe-content">
        <div
            class="alert alert-danger"><?php echo Translate::get('The requested page / data does not exist (anymore).'); ?></div>
        <div class="well">
            <?php echo Translate::get('Maybe it was deleted by another user in the meantime.'); ?>
        </div>
    </div>
