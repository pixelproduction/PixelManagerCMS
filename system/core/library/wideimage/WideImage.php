 ...
 * @copyright 2007-2011
  ...
  **/
	...
	class WideImage
	{
		...
		/**
		 * @var UTF8String Path to the library base directory
		 */
		 ...
		 *
*@return UTF8String The library version
		 */
...
*@return UTF8String
		 ...
		 * </code>
		 * 
		 * @param UTF8String $mapper_class_name
		 * @param UTF8String $mime_type
		 * @param UTF8String $extension
		 */
		 ...
		 * 
		 * @param UTF8String $uri File or url
		 *
*@return WideImage_Image WideImage_PaletteImage or WideImage_TrueColorImage instance
		 */
		 ...
		 * 
		 * @param UTF8String $string Binary data, i.e. from BLOB field in the database
		 *
*@return WideImage_Image WideImage_PaletteImage or WideImage_TrueColorImage instance
		 */
