 ...
 * @copyright 2007-2011
  ...
  **/
	...
	abstract class WideImage_Image
	{
		 ...
		 * </code>
		 * 
		 * @param UTF8String $uri File location
		 */
		 ...
		 * 
		 * @param UTF8String $format The format of the image
		 *
*@return UTF8String The binary image data in specified format
		 */
		 ...
		 * </code>
		 * 
		 * @param UTF8String $format Image format
		 */
...
*@return object
		 ...
		 * @param UTF8String $fit    'inside', 'outside', 'fill'
		 * @param UTF8String $scale  'down', 'up', 'any'
		 *
...
*@return WideImage_Image resized image
		 ...
		 * @param UTF8String $scale    Possible values: 'up' (enlarge only), 'down' (downsize only), 'any' (resize precisely to $width x $height). Defaults to 'any'.
...
*@return WideImage_Image The resulting image with resized canvas
		 ...
		 * @param UTF8String $type   Type of noise 'salt&pepper', 'color' or 'mono'
		 *
