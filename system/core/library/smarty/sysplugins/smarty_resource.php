...
abstract class Smarty_Resource
{
     ...
     *
     * @return UTF8String                 template source
     ...
     * @param  UTF8String $resource_name resource_name to make unique
     * @param  boolean    $isConfig      flag for config resource
     *
     * @return UTF8String unique resource name
     */
     ...
     * @param  Smarty_Template_Source $source source object
     *
     * @return UTF8String                 resource's basename
     */
     ...
     * @param  UTF8String $type   name of the resource
     *
     ...
     *
     * @param  UTF8String $resource_name    template_resource or config_resource to parse
     * @param  UTF8String $default_resource the default resource_type defined in $smarty
     *
     ...
     * @param  UTF8String               $template_resource template_resource to extract resource handler and name of
     *
     * @return UTF8String unique resource name
     */
     ...
     * @param  Smarty_Internal_Template $_template         template object
     * @param  Smarty                   $smarty            smarty object
     * @param  UTF8String               $template_resource resource identifier
     *
