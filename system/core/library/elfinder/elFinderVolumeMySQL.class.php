...
*@return misc
	 ...
	 * @param  UTF8String $name object name
	 * @param  UTF8String $mime mime type
	 *
*@return bool
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return void
	 ...
	 *
	 * @param  UTF8String $path file path (id)
	 *
	 * @return UTF8String
...
*@return array
	 ...
	 *
	 * @param  UTF8String $path file path
	 * @param  UTF8String $mode open file mode (ignored in this driver)
	 *
