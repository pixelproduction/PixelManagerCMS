...
abstract class elFinderVolumeDriver {
	 ...
	 *
	 * @param  UTF8String $cmd command name
	 *
*@return bool
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  UTF8String $mime  mime type to check
...
*@return bool|null
	 ...
	 *
	 * @param  UTF8String $hash file hash
	 *
*@return UTF8String
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return UTF8String
	 ...
	 *
	 * @param  UTF8String $hash file hash
	 * @param  UTF8String $attr attribute name
...
*@return array|false
	 ...
	 * Return folder info
	 *
	 * @param  UTF8String $hash   folder hash
...
*@return array
	 ...
	 *
	 * @param  UTF8String   $hash  folder hash or empty string to get tree from root folder
	 * @param  int      $deep  subdir deep
	 * @param  UTF8String   $exclude  dir hash which subfolders must be exluded from result, required to not get stat twice on cwd subfolders
	 *
*@return array|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  UTF8String  $hash  directory hash
	 *
*@return array
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return void
	 ...
	 *
	 * @param  UTF8String   $dst  destination directory
	 * @param  UTF8String   $name directory name
	 *
*@return array|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  UTF8String   $dst  destination directory
	 * @param  UTF8String   $name file name
	 *
*@return array|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  UTF8String  $hash file hash
	 * @param  UTF8String  $name new file name
	 *
*@return array|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  UTF8String   $hash   file hash
	 * @param  UTF8String   $suffix suffix to add to file name
	 *
*@return array|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  Resource   $fp      file pointer
	 * @param  UTF8String $dst     destination folder hash
	 * @param  UTF8String $src     file name
	 * @param  UTF8String $tmpname file tmp name - required to detect mime type
	 *
*@return array|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 * @param  UTF8String $source file hash
	 * @param  UTF8String $dst    destination dir hash
...
*@return UTF8String|false
	 ...
	 *
	 * @param  UTF8String $hash    file hash
	 * @param  UTF8String $content new file content
	 *
*@return array
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  UTF8String  $hash  archive hash
	 *
*@return array|bool
	 * @author Dmitry (dio) Levashov, 
	 * @author Alexey Sukhotin
	 ...
	 * Resize image
	 *
	 * @param  UTF8String   $hash image file
	 * @param  int      $width    new width
	 * @param  int      $height   new height
	 * @param  int      $x        X start poistion for crop
	 * @param  int      $y        Y start poistion for crop
	 * @param  UTF8String   $mode action how to mainpulate image
	 *
*@return array|false
	 * @author Dmitry (dio) Levashov
	 * @author Alexey Sukhotin
	 ...
	 * Search files
	 *
	 * @param  UTF8String  $q  search string
	 * @param  array   $mimes
	 * @return array
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return bool
	 ...
	 *
	 * @param  UTF8String $path   file path
	 * @param  UTF8String $suffix suffix append to name
	 *
*@return UTF8String
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  UTF8String  $path  file path
	 * @param  UTF8String  $name  attribute name (read|write|locked|hidden)
...
*@return bool
	 ...
	 *
	 * @param UTF8String $dir  parent dir path
	 * @param UTF8String $name new file name
	 *
*@return bool
	 * @author Dmitry (dio) Levashov
	 ...
	 * Return fileinfo 
	 *
	 * @param  UTF8String  $path  file cache
	 * @return array
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return UTF8String
	 ...
	 *
	 * @param  UTF8String  $mime1  mimetype
	 * @param  UTF8String  $mime2  mimetype
	 *
*@return bool
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return UTF8String|false
	 ...
	 *
	 * @param  UTF8String  $path  dir path
	 *
*@return array
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 * Return subdirs tree
	 *
	 * @param  UTF8String  $path  parent dir path
...
*@return array
	 ...
	 *
	 * @param  UTF8String  $src  source path
	 * @param  UTF8String  $dst  destination dir path
	 * @param  UTF8String  $name new file name (optionaly)
	 *
*@return UTF8String|false
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return UTF8String|false
	 ...
	 *
	 * @param  Object  $volume       source volume
	 * @param  UTF8String  $src          source file hash
	 * @param  UTF8String  $destination  destination dir path
	 * @param  UTF8String  $name         file name
	 *
*@return UTF8String|false
	 * @author Dmitry (dio) Levashov
...
*@return UTF8String|false
	 ...
	 *
	 * @param  UTF8String $path thumnbnail path
	 * @param  array      $stat file stat
	 *
*@return UTF8String|bool
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return UTF8String|bool
	 ...
	 *
	 * @param  UTF8String $path file path
	 * @param  UTF8String $mime file mime type
	 *
*@return UTF8String|false
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return UTF8String|false
	 ...
	 * @param  UTF8String $bgcolor    square background color in #rrggbb format
	 * @param  UTF8String $destformat image destination format
	 *
*@return UTF8String|false
	 * @author Dmitry (dio) Levashov
...
*@return UTF8String|false
	 ...
	 *
	 * @param  UTF8String  $command       command line
	 ...
	 *
	 * @param  UTF8String  $stat  file stat
	 * @return void
	 * @author Dmitry (dio) Levashov
	 * @author Naoki Sawada
	 * @author Troex Nevelin
...
*@return gd image resource identifier
	 ...
	 * @param UTF8String $filename   The path to save the file to.
	 * @param UTF8String $destformat The Image type to use for $filename
	 * @param UTF8String $mime       The original image mime type
	 */
	 ...
	 *
	 * @param resource $image gd image resource
	 * @param UTF8String $bgcolor background color in #rrggbb format
	 */
	...
	*
	* @param  UTF8String  $haystack  The string being checked.
	* @param  UTF8String  $needle    The string to find in haystack.
...
*@return UTF8String
	 ...
	 *
	 * @param  UTF8String  $path  rel file path
	 *
*@return UTF8String
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return UTF8String
	 ...
	 *
	 * @param  UTF8String  $path    path to check
	 * @param  UTF8String  $parent  parent path
	 *
*@return bool
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return array
	 ...
	 *
	 * @param  UTF8String  $path  parent dir path
	 * @param UTF8String  $name  new directory name
	 *
*@return UTF8String|bool
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return UTF8String|bool
	 ...
	 * Create symlink
	 *
	 * @param  UTF8String $source    file to link to
	 * @param  UTF8String $targetDir folder to create link in
	 * @param  UTF8String $name      symlink name
	 *
*@return bool
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  UTF8String  $source  source file path
	 * @param  UTF8String  $target  target dir path
	 * @param  UTF8String  $name    file name
	 *
*@return bool
	 * @author Dmitry (dio) Levashov
...
*@return bool
	 ...
	 *
	 * @param  resource  $fp   file pointer
	 * @param  UTF8String    $dir  target dir path
	 * @param  UTF8String    $name file name
	 * @param  array     $stat file stat (required by some virtual fs)
	 *
*@return bool|UTF8String
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return bool
	 ...
	 *
	 * @param  UTF8String $dir   target dir
	 * @param  array      $files files names list
	 * @param  UTF8String $name  archive name
	 * @param  array      $arc   archiver options
	 *
*@return UTF8String|bool
	 * @author Dmitry (dio) Levashov, 
