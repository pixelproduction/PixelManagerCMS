...
abstract class Smarty_Internal_TemplateCompilerBase
{
     ...
     *
     * @param  UTF8String $tag       tag name
     * @param  array      $args      array with tag attributes
     * @param  array      $parameter array with compilation parameter
     *
     * @throws SmartyCompilerException
     * @throws SmartyException
     * @return UTF8String compiled code
     */
     ...
     *
     * @param         $plugin_name
     * @param  UTF8String $plugin_type type of plugin
     *
     * @return UTF8String call name of function
     */
     ...
     *
     * @param  UTF8String $tag         name of tag
     * @param  UTF8String $plugin_type type of plugin
     *
     ...
     *
     * @param UTF8String $left
     * @param UTF8String $right
     *
     * @return UTF8String
     */
     ...
     *
     * @param  UTF8String $content content of template element
     ...
     *
     * @param UTF8String $code PHP code
     *
     * @return UTF8String
     */
     ...
     *
     * @param UTF8String $file  new filename
     * @param UTF8String $uid   uid of file
     ...
     *
     * @param  UTF8String $args individual error message or null
     * @param  UTF8String $line line-number
     *
