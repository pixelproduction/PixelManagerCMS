...
class elFinderVolumeFTP extends elFinderVolumeDriver {
	 ...
	 *
	 * @param  UTF8String $raw line from ftp_rawlist() output
	 *
*@return array
	 ...
	 *
	 * @param  UTF8String $perm permissions string
	 *
*@return UTF8String
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return UTF8String|bool
	 ...
	 *
	 * @param  UTF8String $target link target
	 * @param  UTF8String $path   symlink path
	 *
*@return bool
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 * @param  UTF8String  $targetDir target directory path
	 * @param  UTF8String  $name      new file name
	 *
*@return bool
	 * @author Dmitry (dio) Levashov
...
*@return bool
	 ...
	 * Unpack archive
	 *
	 * @param  UTF8String  $path  archive path
	 ...
	 *
	 * @param  UTF8String  $path  file/dir path
	 *
*@return bool
	 * @author Dmitry (dio) Levashov
	 **/
...
*@return UTF8String|bool
	 ...
	 *
*@return UTF8String path to the new temporary directory or false in case of error.
	 */
	 ...
	 *
*@param $remote_directory UTF8String remote FTP path to scan for file and folders recursively
	 *
*@return array of elements each of which is an array of two elements:
	 ...
	 *
*@param $remote_directory UTF8String remote FTP path to a source directory to download from.
	 * @param array $files list of files to download from remote directory.
	 * @param $dest_local_directory UTF8String destination folder to store downloaded files.
	 *
*@return bool true on success and false on failure.
	 ...
	 *
*@param $dirPath UTF8String to directory to be erased.
	 *
*@return bool true on success and false on failure.
	 */
...
/**
	 * Resize image
	 *
*@param UTF8String       $hash
	 * @param int        $width
 * @param int            $height
 * @param int            $x
	 * @param int        $y
	 * @param UTF8String $mode
	 * @param UTF8String $bg
	 * @param int        $degree
	 *
