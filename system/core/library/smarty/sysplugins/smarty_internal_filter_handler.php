...
class Smarty_Internal_Filter_Handler
{
     ...
     *
     * @param  UTF8String               $type     the type of filter ('pre','post','output') which shall run
     * @param  UTF8String               $content  the content which shall be processed by the filters
     * @param  Smarty_Internal_Template $template template object
     *
     * @throws SmartyException
     * @return UTF8String                   the filtered content
     */
