...
abstract class Smarty_CacheResource_KeyValueStore extends Smarty_CacheResource
{
     ...
     *
     * @param  Smarty_Internal_Template $_template template object
     * @param  UTF8String               $content   content to cache
     *
     ...
     * @param  UTF8String $compile_id    compile id
     *
     * @return UTF8String filepath of cache file
     */
     ...
     *
     * @param  UTF8String $string CacheID component to sanitize
     *
     * @return UTF8String sanitized CacheID component
     */
     ...
     *
     * @param  UTF8String $cid           CacheID to fetch
     * @param  UTF8String $resource_name template name
     * @param  UTF8String $cache_id      cache id
     * @param  UTF8String $compile_id    compile id
     * @param  UTF8String $content       cached content
     * @param  integer    &$timestamp    cached timestamp (epoch)
     * @param  UTF8String $resource_uid  resource's uid
     *
     * @return boolean success
     */
     ...
     *
     * @param UTF8String &$content the content to be cached
     */
     ...
     *
     * @param  UTF8String &$content the cached content
     *
     ...
     * Invalidate CacheID
     *
     * @param  UTF8String $cid           CacheID
     * @param  UTF8String $resource_name template name
     * @param  UTF8String $cache_id      cache id
     * @param  UTF8String $compile_id    compile id
     * @param  UTF8String $resource_uid  source's uid
     *
     * @return void
     */
     ...
     *
     * @param  UTF8String $cid           CacheID to determine latest invalidation timestamp of
     * @param  UTF8String $resource_name template name
     * @param  UTF8String $cache_id      cache id
     * @param  UTF8String $compile_id    compile id
     * @param  UTF8String $resource_uid  source's filepath
     *
     ...
     *
     * @param  UTF8String $cid           CacheID to translate
     * @param  UTF8String $resource_name template name
     * @param  UTF8String $cache_id      cache id
     * @param  UTF8String $compile_id    compile id
     * @param  UTF8String $resource_uid  source's filepath
