...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     *
     * @param  UTF8String $template         the resource handle of the template file or template object
     ...
     * @return UTF8String rendered template output
     */
     ...
     *
     * @param  UTF8String $resource_name template name
     *
     ...
     *
     * @param  UTF8String $varname variable name or null
     *
     * @return UTF8String variable value or or array of variables
     */
     ...
     * @param  UTF8String $type     resource type
     *
     ...
     *
     * @param  UTF8String $template_name template name
     * @param  UTF8String $cache_id      cache id
     * @param  UTF8String $compile_id    compile id
     * @param  integer    $exp_time      expiration time
     * @param  UTF8String $type          resource type
     *
     * @return integer number of cache files deleted
     ...
     *
     * @param  UTF8String|Smarty_Security $security_class if a string is used, it must be class-name
     *
     ...
     *
     * @param  UTF8String|array $template_dir directory(s) of template sources
     *
     * @return Smarty       current Smarty instance for chaining
     */
     ...
     *
     * @param  UTF8String|array $template_dir directory(s) of template sources
     * @param  UTF8String       $key          of the array element to assign the template dir to
     *
     * @return Smarty          current Smarty instance for chaining
     ...
     *
     * @return array|UTF8String list of template directories, or directory of $index
     */
     ...
     *
     * @param UTF8String|array $config_dir directory(s) of config sources
     ...
     * @param mixed $index index of directory to get, null to get all
     *
     * @return array|UTF8String configuration directory
     */
     ...
     *
     * @param  UTF8String|array $plugins_dir directory(s) of plugins
     *
     * @return Smarty       current Smarty instance for chaining
     */
     ...
     *
     * @param  UTF8String $compile_dir directory to store compiled templates in
     *
     * @return Smarty current Smarty instance for chaining
     */
     ...
     *
     * @return UTF8String path to compiled templates
     */
     ...
     * Set cache directory
     *
     * @param  UTF8String $cache_dir directory to store cached templates in
     *
     * @return Smarty current Smarty instance for chaining
     */
     ...
     * Get cache directory
     *
     * @return UTF8String path of cache directory
     */
     ...
     *
     * @param UTF8String       $dirName directory property name
     * @param UTF8String|array $dir     directory string or array of strings
     ...
     *
     * @param  array|UTF8String $modifiers modifier or list of modifiers to set
     *
     * @return Smarty       current Smarty instance for chaining
     */
     ...
     *
     * @param  array|UTF8String $modifiers modifier or list of modifiers to add
     *
     * @return Smarty       current Smarty instance for chaining
     */
     ...
     * @param  UTF8String $type    "pre", "output", … specify the filter type to set. Defaults to none treating $filters'
     ...
     *
     * @param  UTF8String $type type of filter to get autoloads for. Defaults to all autoload filters
     *
     ...
     *
     * @param  UTF8String $template   the resource handle of the template file
     * @param  mixed      $cache_id   cache id to be used with this template
     * @param  mixed      $compile_id compile id to be used with this template
     * @param  object     $parent     next higher level of Smarty variables
     ...
     *
     * @param  UTF8String $plugin_name class plugin name to load
     * @param  bool       $check       check if already loaded
     *
     * @throws SmartyException
     * @return UTF8String |boolean filepath of loaded file or false
     */
     ...
     *
     * @param  UTF8String $extension     file extension
    ...
    /**
     * @param UTF8String $left_delimiter
     */
    ...
    /**
     * @param UTF8String $right_delimiter
     */
     ...
     *
     * @param  UTF8String $name property name
     *
     * @return mixed
     */
